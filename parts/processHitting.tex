...
Let $t, t'$ and ($t+D$) be time steps, if no action are being played at $t$, then $h$ can be chosen to be played so that the semantics of $\PH$ can be expressed as follows:
