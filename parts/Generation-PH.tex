...
A chronogram is the discritized time evolution of the time series data of each component of biological regulatory networks. It is presented by the fonction below: $$\mathds{N}^+ \longmapsto \mathds{N}^+$$
