...
\begin{figure}[h]
\includegraphics[width =0.3\linewidth]{images/courbes/gene-a.pdf}
\includegraphics[width =0.3\linewidth]{images/courbes/gene-b.pdf}
\includegraphics[width =0.3\linewidth]{images/courbes/gene-z.pdf}

\includegraphics[width =0.3\linewidth]{images/courbes/gene-a-disc-change.pdf}
\includegraphics[width =0.3\linewidth]{images/courbes/gene-b-disc-change.pdf}
\includegraphics[width =0.3\linewidth]{images/courbes/gene-z-disc-change.pdf}
